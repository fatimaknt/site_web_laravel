            ...
            <div class="app-card app-card-settings shadow-sm p-4">
                ...
                <div class="app-card-body">
                    <form class="settings-form" method="POST" action="{{ route('administrateurs.store') }}">
                        @csrf
                        <div class="mb-3">
                            <label for="setting-input-1" class="form-label">Nom Complet<span class="ms-2"
                            ...
                            <input type="text" class="form-control" name="name" id="setting-input-1"
                                placeholder="Entrer le nom de l'employé" value="{{ old('name') }}" required>
                            @error('name')
