        ...
        <div class="col-12 col-md-8">
            <div class="app-card app-card-settings shadow-sm p-4">
                ...
                <div class="app-card-body">
                    <form class="settings-form" method="POST" action="{{ route('employers.update', $employe->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nom" id="setting-input-1"
                                placeholder="Entrer le nom de l'employé" value="{{ $employe->nom }}" required>
                            @error('nom')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-2"
                                placeholder="Entrer le prenom de l'employé" name="prenom" value="{{ $employe->prenom }}">
                            @error('prenom')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="setting-input-3"
                                placeholder="Entrer l'email de l'employé" name="email" value="{{ $employe->email }}"
                                required>
                            @error('email')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-3"
                                placeholder="Entrer le contact de l'employé" name="contact" value="{{ $employe->contact }}"
                                required>
                            @error('contact')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="setting-input-3"
                                placeholder="Entrer le montant journalier" name="montant_journalier"
                                value="{{ $employe->montant_journalier }}" required>
