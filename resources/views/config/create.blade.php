                    ...
                    <form class="settings-form" method="POST" action="{{ route('configurations.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="type" id="type" class="form-control">
                                <option value="">Selectionnez le type de configuration</option>
                        ...
                        <div class="mb-3">
                            <label for="setting-input-1" class="form-label">Valeur<span class="ms-2" data-container="body"
                            ...
                            <input type="text" class="form-control" name="value" id="setting-input-1"
                                placeholder="Entrer la valeur" value="{{ old('value') }}" required>
                            @error('value')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
