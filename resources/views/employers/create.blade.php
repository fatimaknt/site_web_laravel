...
@section('content')
    ...
    <div class="row g-4 settings-section">
        <div class="col-12 col-md-4">
            ...
            <div class="section-intro">Ajouter ici un nouvel employé </div>
        </div>
                    ...
                    <form class="settings-form" method="POST" action="{{ route('employers.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nom" id="setting-input-1"
                                placeholder="Entrer le nom de l'employé" value="{{ old('nom') }}" required>
                            @error('nom')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-2"
                                placeholder="Entrer le prenom de l'employé" name="prenom" value="{{ old('prenom') }}">
                            @error('prenom')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="setting-input-3"
                                placeholder="Entrer l'email de l'employé" name="email" value="{{ old('email') }}"
                                required>
                            @error('email')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-3"
                                placeholder="Entrer le contact de l'employé" name="contact" value="{{ old('contact') }}"
                                required>
                            @error('contact')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="setting-input-3"
                                ...
                                value="{{ old('montant_journalier') }}" required>
